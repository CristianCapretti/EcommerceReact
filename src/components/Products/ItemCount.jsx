...
const ItemCount=({stock,onAdd}) => {
    ...
    return (
        <div className="container">
            ...
            <div className="row">
                <div className="col">
                {itemAdded ? <Link to={"/cart"} className="btn btn-dark mt-3">Finalizar Compra</Link> : <button type="button" className="btn btn-dark mt-3" onClick={addToCart}>Agregar al Carrito</button>}
                </div>
            </div>
        </div>        
